...
export default function RouterLabel({ trade, color }: { trade: SubmittableTrade; color?: keyof DefaultTheme }) {
  ...
  if (trade.quoteMethod === QuoteMethod.CLIENT_SIDE_FALLBACK) {
    return <ThemedText.BodySmall color={color}>Proxyswap Client</ThemedText.BodySmall>
  }

  return <ThemedText.BodySmall color={color}>Proxyswap API</ThemedText.BodySmall>
}
