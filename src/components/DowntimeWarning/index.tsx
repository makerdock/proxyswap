  ...
  switch (chainId) {
    ...
    case SupportedChainId.MANTLE:
      return (
        <Wrapper>
          <Trans>
            Mantle is in Beta and may experience downtime. During downtime, your position will not earn fees and you
            will be unable to remove liquidity. <ReadMoreLink href="">Read more.</ReadMoreLink>
          </Trans>
        </Wrapper>
      )
    ...
    case SupportedChainId.DEGEN:
      return (
        <Wrapper>
          <Trans>
            Degen is in Beta and may experience downtime. During downtime, your position will not earn fees and you will
            be unable to remove liquidity. <ReadMoreLink href="">Read more.</ReadMoreLink>
          </Trans>
        </Wrapper>
      )
