...
import mantleLogoUrl from 'assets/svg/mantle_logo.svg'
import optimismLogoUrl from 'assets/svg/optimistic_ethereum.svg'
import polygonMaticLogo from 'assets/svg/polygon-matic-logo.svg'
import ms from 'ms.macro'

import { SupportedChainId, SupportedL1ChainId, SupportedL2ChainId } from './chains'
import { ARBITRUM_LIST, CELO_LIST, DEGEN_LIST, MANTLE_LIST, OPTIMISM_LIST } from './lists'
...
const CHAIN_INFO: ChainInfoMap = {
  ...
  [SupportedChainId.MANTLE]: {
    ...
    infoLink: '',
    label: 'Mantle',
    logoUrl: mantleLogoUrl,
    defaultListUrl: MANTLE_LIST,
    helpCenterUrl: '',
...
export const MAINNET_INFO = CHAIN_INFO[SupportedChainId.DEGEN]
