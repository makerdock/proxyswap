...
// } from './tokens'
import { nativeOnChain, USDT_DEGEN, WRAPPED_NATIVE_CURRENCY } from './tokens'
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  // [SupportedChainId.MANTLE]: [...WRAPPED_NATIVE_CURRENCIES_ONLY[SupportedChainId.MANTLE], DAI_MANTLE, USDC_MANTLE],
  [SupportedChainId.DEGEN]: [...WRAPPED_NATIVE_CURRENCIES_ONLY[SupportedChainId.DEGEN], USDT_DEGEN],
}
...
export const COMMON_BASES: ChainCurrencyList = {
  ...
  //   nativeOnChain(SupportedChainId.MANTLE),
  //   DAI_MANTLE,
  //   USDC_MANTLE,
  //   WRAPPED_NATIVE_CURRENCY[SupportedChainId.MANTLE] as Token,
  // ],
