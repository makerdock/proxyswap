...
export default function AddLiquidity() {
  ...
  async function onAdd() {
    ...
    if (position && account && deadline) {
      ...
      console.log('onAdd', position, tokenId, calldata, value, amount0Min, amount1Min, useNative)
      ...
      if (argentWalletContract) {
        ...
        const batch = [
          ...(amountA && amountA.currency.isToken && !amountA.currency.equals(DEGEN)
            ? [approveAmountCalldata(amountA, NONFUNGIBLE_POSITION_MANAGER_ADDRESSES[chainId])]
            : []),
          ...(amountB && amountB.currency.isToken && !amountB.currency.equals(DEGEN)
        ...
        console.log('argentWalletContract', batch)
