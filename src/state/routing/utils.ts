...
export function computeRoutes(
  ...
  const parsedCurrencyIn =
    currencyIn.isNative || currencyIn.equals(DEGEN) ? nativeOnChain(currencyIn.chainId) : parsedTokenIn
  const parsedCurrencyOut =
    currencyOut.isNative || currencyOut.equals(DEGEN) ? nativeOnChain(currencyOut.chainId) : parsedTokenOut
