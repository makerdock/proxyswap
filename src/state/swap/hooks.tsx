...
import { DEGEN, TOKEN_SHORTHANDS } from '../../constants/tokens'
  ...
  const onCurrencySelection = useCallback(
    (field: Field, currency: Currency) => {
      dispatch(
        selectCurrency({
          field,
          currencyId: currency.isNative || currency.equals(DEGEN) ? 'ETH' : currency.isToken ? currency.address : '',
        })
      )
    },
    [dispatch]
...
export function useDerivedSwapInfo(): {
  ...
  // console.log(trade, 'useBestTrade')
