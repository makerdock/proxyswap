...
export default function RadialGradientByChainUpdater(): null {
  ...
  useEffect(() => {
    ...
    switch (chainId) {
      ...
      //   setBackground(backgroundResetStyles)
      //   const mantleLightGradient = 'radial-gradient(150% 100% at 50% 0%, #CDE8FB 0%, #FCF3F9 50%, #FFFFFF 100%)'
      //   const mantleDarkGradient = 'radial-gradient(150% 100% at 50% 0%, #0A294B 0%, #221E30 50%, #1F2128 100%)'
      //   backgroundRadialGradientElement.style.background = darkMode ? mantleDarkGradient : mantleLightGradient
      //   break
